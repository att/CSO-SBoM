...
## print servers that fit into CVSS category - ADDED

print("Worst Servers", (svr10)) #Output - vulnerable packages that fit into CVSS category
print()
print()
print("Critical Servers", (svr7))
print()
print()
print("Medium Servers", (svr5))
print()
print()
print("Low Servers", (svr0))
